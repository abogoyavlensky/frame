...
- [ ] **Step 1: Create `src/frame/version.lg`**
...
- [ ] **Step 3: Implement the helpers in `config.lg`**
...
- [ ] **Step 1: Write failing tests through `read-config`**
...
- [ ] **Step 3: Implement in `read-config`**
...
- [ ] **Step 1: Print warnings after reading config**
